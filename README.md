...
| **Dashboard** | Unified dark UI at port **8787** (catalog, SIT cases, repository cases, schedules, kit log) |
| **SIT console** | Existing post-deploy runner UI at **8098** (preserved; same cases) |
