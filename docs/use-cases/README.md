...
Operator display, mapping, viewer, export and tenant-preservation rules: [MAINTENANCE.md](MAINTENANCE.md).
...
The in-console viewer on a mapped screen downloads the same revision it displays.
